...
<tr><td><code><a href="#xsd__unsignedShort_"> xsd__unsignedShort_ </a></code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:342 </td><td> yes </td></tr>
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 321, is a simple content wrapper *`xsd:unsignedByte`*, meaning it wraps a primitive type, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 335, is a simple content wrapper *`xsd:unsignedLong`*, meaning it wraps a primitive type, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 342, is a simple content wrapper *`xsd:unsignedShort`*, meaning it wraps a primitive type, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 432, is a simple content wrapper *`ns2:char`*, meaning it wraps a primitive type, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 446, is a simple content wrapper *`ns2:duration`*, meaning it wraps a primitive type, and has the following auto-completed declaration in soapStub.h:
...
- <code><a href="#xsd__anyType"> xsd__anyType </a></code> is the base class of this derived class
- `std::string __item` is simple content of XML schema type *`ns2:duration`* wrapped in *`ns2:duration`* (the leading underscores of the member name make this member invisible in XML, meaning it has no element tag)
...
- `ns2__duration__ *soap_new_req_ns2__duration__(struct soap*, const std::string& __item)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns2__duration__ *soap_new_set_ns2__duration__(struct soap*, const std::string& __item, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 459, is a simple content wrapper *`ns2:guid`*, meaning it wraps a primitive type, and has the following auto-completed declaration in soapStub.h:
...
- <code><a href="#xsd__anyType"> xsd__anyType </a></code> is the base class of this derived class
- `std::string __item` is simple content of XML schema type *`ns2:guid`* wrapped in *`ns2:guid`* (the leading underscores of the member name make this member invisible in XML, meaning it has no element tag)
...
- `ns2__guid__ *soap_new_req_ns2__guid__(struct soap*, const std::string& __item)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns2__guid__ *soap_new_set_ns2__guid__(struct soap*, const std::string& __item, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 495, is a simple content wrapper *`ns5:StreamBody`*, meaning it wraps a primitive type, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 355, is serialized as XML schema type *`ns1:Sign`*, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 357, is serialized as XML schema type *`ns1:SignResponse`*, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 359, is serialized as XML schema type *`ns1:Journal`*, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 361, is serialized as XML schema type *`ns1:JournalResponse`*, and has the following auto-completed declaration in soapStub.h:
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 363, is serialized as XML schema type *`ns1:Echo`*, and has the following auto-completed declaration in soapStub.h:
...
- `std::string *message` is an optional element *`<ns1:message>`* of XML schema type *`xsd:string`*
- `struct soap *soap` the context that manages this object
...
- `_ns1__Echo *soap_new_set__ns1__Echo(struct soap*, std::string *message)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 365, is serialized as XML schema type *`ns1:EchoResponse`*, and has the following auto-completed declaration in soapStub.h:
...
- `std::string *EchoResult` is an optional element *`<ns1:EchoResult>`* of XML schema type *`xsd:string`*
- `struct soap *soap` the context that manages this object
...
- `_ns1__EchoResponse *soap_new_set__ns1__EchoResponse(struct soap*, std::string *EchoResult)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 367, is serialized as XML schema type *`ns3:ReceiptRequest`*, and has the following auto-completed declaration in soapStub.h:
...
- <code><a href="#xsd__anyType"> xsd__anyType </a></code> is the base class of this derived class
- `std::string *ftCashBoxID` is a required nillable (xsi:nil when NULL) element *`<ns3:ftCashBoxID>`* of XML schema type *`xsd:string`*
- `std::string *ftQueueID` is an optional element *`<ns3:ftQueueID>`* of XML schema type *`xsd:string`*
- `std::string *ftPosSystemId` is an optional element *`<ns3:ftPosSystemId>`* of XML schema type *`xsd:string`*
- `std::string *cbTerminalID` is a required nillable (xsi:nil when NULL) element *`<ns3:cbTerminalID>`* of XML schema type *`xsd:string`*
- `std::string *cbReceiptReference` is a required nillable (xsi:nil when NULL) element *`<ns3:cbReceiptReference>`* of XML schema type *`xsd:string`*
...
- `std::string *ftReceiptCaseData` is an optional element *`<ns3:ftReceiptCaseData>`* of XML schema type *`xsd:string`*
- `std::string *cbReceiptAmount` is an optional element *`<ns3:cbReceiptAmount>`* of XML schema type *`xsd:decimal`*
- `std::string *cbUser` is an optional element *`<ns3:cbUser>`* of XML schema type *`xsd:string`*
- `std::string *cbArea` is an optional element *`<ns3:cbArea>`* of XML schema type *`xsd:string`*
- `std::string *cbCustomer` is an optional element *`<ns3:cbCustomer>`* of XML schema type *`xsd:string`*
- `std::string *cbSettlement` is an optional element *`<ns3:cbSettlement>`* of XML schema type *`xsd:string`*
- `std::string *cbPreviousReceiptReference` is an optional element *`<ns3:cbPreviousReceiptReference>`* of XML schema type *`xsd:string`*
...
- `ns3__ReceiptRequest *soap_new_req_ns3__ReceiptRequest(struct soap*, std::string *ftCashBoxID, std::string *cbTerminalID, std::string *cbReceiptReference, time_t cbReceiptMoment, ns3__ArrayOfChargeItem *cbChargeItems, ns3__ArrayOfPayItem *cbPayItems, LONG64 ftReceiptCase)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns3__ReceiptRequest *soap_new_set_ns3__ReceiptRequest(struct soap*, std::string *ftCashBoxID, std::string *ftQueueID, std::string *ftPosSystemId, std::string *cbTerminalID, std::string *cbReceiptReference, time_t cbReceiptMoment, ns3__ArrayOfChargeItem *cbChargeItems, ns3__ArrayOfPayItem *cbPayItems, LONG64 ftReceiptCase, std::string *ftReceiptCaseData, std::string *cbReceiptAmount, std::string *cbUser, std::string *cbArea, std::string *cbCustomer, std::string *cbSettlement, std::string *cbPreviousReceiptReference, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 369, is serialized as XML schema type *`ns3:ArrayOfChargeItem`*, and has the following auto-completed declaration in soapStub.h:

    class SOAP_CMAC ns3__ArrayOfChargeItem : public xsd__anyType {
      public:
        /// Optional element 'ns3:ChargeItem' of XML schema type 'ns3:ChargeItem'
        std::vector<ns3__ChargeItem *> ChargeItem;
      public:
      ...
      public:
        /// Constructor with default initializations
        ns3__ArrayOfChargeItem() : ChargeItem() { }
...
- <code><a href="#xsd__anyType"> xsd__anyType </a></code> is the base class of this derived class
- `std::vector<ns3__ChargeItem *> ChargeItem` is an optional element *`<ns3:ChargeItem>`* of XML schema type *`ns3:ChargeItem`*, where the type of this member is a container of pointers to <code><a href="#ns3__ChargeItem"> ns3__ChargeItem </a></code>
...
- `ns3__ArrayOfChargeItem *soap_new_req_ns3__ArrayOfChargeItem(struct soap*)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns3__ArrayOfChargeItem *soap_new_set_ns3__ArrayOfChargeItem(struct soap*, const std::vector<ns3__ChargeItem *> & ChargeItem, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 371, is serialized as XML schema type *`ns3:ChargeItem`*, and has the following auto-completed declaration in soapStub.h:
...
- `std::string Quantity` is a required element *`<ns3:Quantity>`* of XML schema type *`xsd:decimal`*
- `std::string *Description` is a required nillable (xsi:nil when NULL) element *`<ns3:Description>`* of XML schema type *`xsd:string`*
- `std::string Amount` is a required element *`<ns3:Amount>`* of XML schema type *`xsd:decimal`*
- `std::string VATRate` is a required element *`<ns3:VATRate>`* of XML schema type *`xsd:decimal`*
- `LONG64 ftChargeItemCase` is a required element *`<ns3:ftChargeItemCase>`* of XML schema type *`xsd:long`*
- `std::string *ftChargeItemCaseData` is an optional element *`<ns3:ftChargeItemCaseData>`* of XML schema type *`xsd:string`*
- `std::string *VATAmount` is an optional element *`<ns3:VATAmount>`* of XML schema type *`xsd:decimal`*
- `std::string *AccountNumber` is an optional element *`<ns3:AccountNumber>`* of XML schema type *`xsd:string`*
- `std::string *CostCenter` is an optional element *`<ns3:CostCenter>`* of XML schema type *`xsd:string`*
- `std::string *ProductGroup` is an optional element *`<ns3:ProductGroup>`* of XML schema type *`xsd:string`*
- `std::string *ProductNumber` is an optional element *`<ns3:ProductNumber>`* of XML schema type *`xsd:string`*
- `std::string *ProductBarcode` is an optional element *`<ns3:ProductBarcode>`* of XML schema type *`xsd:string`*
- `std::string *Unit` is an optional element *`<ns3:Unit>`* of XML schema type *`xsd:string`*
- `std::string *UnitQuantity` is an optional element *`<ns3:UnitQuantity>`* of XML schema type *`xsd:decimal`*
- `std::string *UnitPrice` is an optional element *`<ns3:UnitPrice>`* of XML schema type *`xsd:decimal`*
...
- `ns3__ChargeItem *soap_new_req_ns3__ChargeItem(struct soap*, const std::string& Quantity, std::string *Description, const std::string& Amount, const std::string& VATRate, LONG64 ftChargeItemCase)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns3__ChargeItem *soap_new_set_ns3__ChargeItem(struct soap*, LONG64 *Position, const std::string& Quantity, std::string *Description, const std::string& Amount, const std::string& VATRate, LONG64 ftChargeItemCase, std::string *ftChargeItemCaseData, std::string *VATAmount, std::string *AccountNumber, std::string *CostCenter, std::string *ProductGroup, std::string *ProductNumber, std::string *ProductBarcode, std::string *Unit, std::string *UnitQuantity, std::string *UnitPrice, time_t *Moment, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 373, is serialized as XML schema type *`ns3:ArrayOfPayItem`*, and has the following auto-completed declaration in soapStub.h:

    class SOAP_CMAC ns3__ArrayOfPayItem : public xsd__anyType {
      public:
        /// Optional element 'ns3:PayItem' of XML schema type 'ns3:PayItem'
        std::vector<ns3__PayItem *> PayItem;
      public:
...
- <code><a href="#xsd__anyType"> xsd__anyType </a></code> is the base class of this derived class
- `std::vector<ns3__PayItem *> PayItem` is an optional element *`<ns3:PayItem>`* of XML schema type *`ns3:PayItem`*, where the type of this member is a container of pointers to <code><a href="#ns3__PayItem"> ns3__PayItem </a></code>
...
- `ns3__ArrayOfPayItem *soap_new_req_ns3__ArrayOfPayItem(struct soap*)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns3__ArrayOfPayItem *soap_new_set_ns3__ArrayOfPayItem(struct soap*, const std::vector<ns3__PayItem *> & PayItem, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 375, is serialized as XML schema type *`ns3:PayItem`*, and has the following auto-completed declaration in soapStub.h:
...
- `std::string *ftPayItemCaseData` is an optional element *`<ns3:ftPayItemCaseData>`* of XML schema type *`xsd:string`*
- `std::string *AccountNumber` is an optional element *`<ns3:AccountNumber>`* of XML schema type *`xsd:string`*
- `std::string *CostCenter` is an optional element *`<ns3:CostCenter>`* of XML schema type *`xsd:string`*
- `std::string *MoneyGroup` is an optional element *`<ns3:MoneyGroup>`* of XML schema type *`xsd:string`*
- `std::string *MoneyNumber` is an optional element *`<ns3:MoneyNumber>`* of XML schema type *`xsd:string`*
- `time_t *Moment` is an optional element *`<ns3:Moment>`* of XML schema type *`xsd:dateTime`*
...
- `ns3__PayItem *soap_new_req_ns3__PayItem(struct soap*, const std::string& Quantity, std::string *Description, const std::string& Amount, LONG64 ftPayItemCase)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns3__PayItem *soap_new_set_ns3__PayItem(struct soap*, LONG64 *Position, const std::string& Quantity, std::string *Description, const std::string& Amount, LONG64 ftPayItemCase, std::string *ftPayItemCaseData, std::string *AccountNumber, std::string *CostCenter, std::string *MoneyGroup, std::string *MoneyNumber, time_t *Moment, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 377, is serialized as XML schema type *`ns3:ReceiptResponse`*, and has the following auto-completed declaration in soapStub.h:
...
- <code><a href="#xsd__anyType"> xsd__anyType </a></code> is the base class of this derived class
- `std::string *ftCashBoxID` is a required nillable (xsi:nil when NULL) element *`<ns3:ftCashBoxID>`* of XML schema type *`xsd:string`*
- `std::string *ftQueueID` is a required nillable (xsi:nil when NULL) element *`<ns3:ftQueueID>`* of XML schema type *`xsd:string`*
- `std::string *ftQueueItemID` is a required nillable (xsi:nil when NULL) element *`<ns3:ftQueueItemID>`* of XML schema type *`xsd:string`*
- `LONG64 ftQueueRow` is a required element *`<ns3:ftQueueRow>`* of XML schema type *`xsd:long`*
- `std::string *cbTerminalID` is a required nillable (xsi:nil when NULL) element *`<ns3:cbTerminalID>`* of XML schema type *`xsd:string`*
- `std::string *cbReceiptReference` is a required nillable (xsi:nil when NULL) element *`<ns3:cbReceiptReference>`* of XML schema type *`xsd:string`*
- `std::string *ftCashBoxIdentification` is a required nillable (xsi:nil when NULL) element *`<ns3:ftCashBoxIdentification>`* of XML schema type *`xsd:string`*
- `std::string *ftReceiptIdentification` is a required nillable (xsi:nil when NULL) element *`<ns3:ftReceiptIdentification>`* of XML schema type *`xsd:string`*
...
- `std::string *ftStateData` is an optional element *`<ns3:ftStateData>`* of XML schema type *`xsd:string`*
...
- `ns3__ReceiptResponse *soap_new_req_ns3__ReceiptResponse(struct soap*, std::string *ftCashBoxID, std::string *ftQueueID, std::string *ftQueueItemID, LONG64 ftQueueRow, std::string *cbTerminalID, std::string *cbReceiptReference, std::string *ftCashBoxIdentification, std::string *ftReceiptIdentification, time_t ftReceiptMoment, ns3__ArrayOfSignaturItem *ftSignatures, LONG64 ftState)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns3__ReceiptResponse *soap_new_set_ns3__ReceiptResponse(struct soap*, std::string *ftCashBoxID, std::string *ftQueueID, std::string *ftQueueItemID, LONG64 ftQueueRow, std::string *cbTerminalID, std::string *cbReceiptReference, std::string *ftCashBoxIdentification, std::string *ftReceiptIdentification, time_t ftReceiptMoment, ns4__ArrayOfstring *ftReceiptHeader, ns3__ArrayOfChargeItem *ftChargeItems, ns4__ArrayOfstring *ftChargeLines, ns3__ArrayOfPayItem *ftPayItems, ns4__ArrayOfstring *ftPayLines, ns3__ArrayOfSignaturItem *ftSignatures, ns4__ArrayOfstring *ftReceiptFooter, LONG64 ftState, std::string *ftStateData, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 379, is serialized as XML schema type *`ns3:ArrayOfSignaturItem`*, and has the following auto-completed declaration in soapStub.h:

    class SOAP_CMAC ns3__ArrayOfSignaturItem : public xsd__anyType {
      public:
        /// Optional element 'ns3:SignaturItem' of XML schema type 'ns3:SignaturItem'
        std::vector<ns3__SignaturItem *> SignaturItem;
      public:
      ...
      public:
        /// Constructor with default initializations
        ns3__ArrayOfSignaturItem() : SignaturItem() { }
...
- <code><a href="#xsd__anyType"> xsd__anyType </a></code> is the base class of this derived class
- `std::vector<ns3__SignaturItem *> SignaturItem` is an optional element *`<ns3:SignaturItem>`* of XML schema type *`ns3:SignaturItem`*, where the type of this member is a container of pointers to <code><a href="#ns3__SignaturItem"> ns3__SignaturItem </a></code>
...
- `ns3__ArrayOfSignaturItem *soap_new_req_ns3__ArrayOfSignaturItem(struct soap*)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns3__ArrayOfSignaturItem *soap_new_set_ns3__ArrayOfSignaturItem(struct soap*, const std::vector<ns3__SignaturItem *> & SignaturItem, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 381, is serialized as XML schema type *`ns3:SignaturItem`*, and has the following auto-completed declaration in soapStub.h:
...
- `std::string *Caption` is an optional element *`<ns3:Caption>`* of XML schema type *`xsd:string`*
- `std::string *Data` is a required nillable (xsi:nil when NULL) element *`<ns3:Data>`* of XML schema type *`xsd:string`*
...
- `ns3__SignaturItem *soap_new_req_ns3__SignaturItem(struct soap*, LONG64 ftSignatureFormat, LONG64 ftSignatureType, std::string *Data)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns3__SignaturItem *soap_new_set_ns3__SignaturItem(struct soap*, LONG64 ftSignatureFormat, LONG64 ftSignatureType, std::string *Caption, std::string *Data, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This class is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 383, is serialized as XML schema type *`ns4:ArrayOfstring`*, and has the following auto-completed declaration in soapStub.h:

    class SOAP_CMAC ns4__ArrayOfstring : public xsd__anyType {
      public:
        /// Optional element 'ns4:string' of XML schema type 'xsd:string'
...
- <code><a href="#xsd__anyType"> xsd__anyType </a></code> is the base class of this derived class
- `std::vector<std::string> string` is an optional element *`<ns4:string>`* of XML schema type *`xsd:string`*
...
- `ns4__ArrayOfstring *soap_new_req_ns4__ArrayOfstring(struct soap*)` managed allocation with required members assigned the values of these parameters, with all other members default initialized
- `ns4__ArrayOfstring *soap_new_set_ns4__ArrayOfstring(struct soap*, const std::vector<std::string> & string, char *__item__1)` managed allocation with public members assigned the values of these parameters
...
This struct is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 1278, is a wrapper, meaning that it wraps data and is not visible in XML and is internally used to wrap the request element(s) of the service operation `__ns1__Sign()`.
...
This struct is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 1348, is a wrapper, meaning that it wraps data and is not visible in XML and is internally used to wrap the request element(s) of the service operation `__ns1__Journal()`.
...
This struct is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 1418, is a wrapper, meaning that it wraps data and is not visible in XML and is internally used to wrap the request element(s) of the service operation `__ns1__Echo()`.
...
This struct is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 1653, is recursive, meaning it may (in)directly reference itself through its (base or derived class) members, and is the SOAP protocol *`<SOAP-ENV:Code>`* element.  This struct is for internal use and will be auto-generated when not explicitly declared.
...
This struct is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 1653, is the SOAP protocol *`<SOAP-ENV:Reason>`* element.  This struct is for internal use and will be auto-generated when not explicitly declared.
...
<tr><td><code><a href="#xsd__QName"> xsd__QName </a></code></td><td><code> std::string </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:176 </td><td> yes </td><td> yes </td></tr>
<tr><td><code><a href="#xsd__byte"> xsd__byte </a></code></td><td><code> char </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:187 </td><td> yes </td><td>  </td></tr>
<tr><td><code><a href="#xsd__unsignedByte"> xsd__unsignedByte </a></code></td><td><code> unsigned char </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:190 </td><td> yes </td><td>  </td></tr>
<tr><td><code><a href="#xsd__ID"> xsd__ID </a></code></td><td><code> std::string </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:193 </td><td> yes </td><td>  </td></tr>
<tr><td><code><a href="#xsd__IDREF"> xsd__IDREF </a></code></td><td><code> std::string </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:203 </td><td> yes </td><td>  </td></tr>
<tr><td><code><a href="#xsd__anyURI"> xsd__anyURI </a></code></td><td><code> std::string </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:220 </td><td> yes </td><td>  </td></tr>
<tr><td><code><a href="#xsd__decimal"> xsd__decimal </a></code></td><td><code> std::string </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:258 </td><td> yes </td><td>  </td></tr>
<tr><td><code><a href="#xsd__duration"> xsd__duration </a></code></td><td><code> std::string </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:275 </td><td> yes </td><td>  </td></tr>
<tr><td><code><a href="#ns2__char"> ns2__char </a></code></td><td><code> int </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:427 </td><td> yes </td><td>  </td></tr>
<tr><td><code><a href="#ns2__duration"> ns2__duration </a></code></td><td><code> std::string </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:441 </td><td> yes </td><td>  </td></tr>
<tr><td><code><a href="#ns2__guid"> ns2__guid </a></code></td><td><code> std::string </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:454 </td><td> yes </td><td>  </td></tr>
<tr><td><code><a href="#ns5__StreamBody"> ns5__StreamBody </a></code></td><td><code> xsd__base64Binary </code></td><td> .\lib\gsoap\gsoap\bin\win32\ftservice.h:490 </td><td> yes </td><td>  </td></tr>
</table>
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 176, is serialized as XML schema type *`xsd:QName`* and is a built-in string type to serialize a list of space-separated qualified names (*`xsd:QName`*), such that XML namespace prefixes are normalized to the XML prefixes defined in the [namespace table](#doc-namespaces) or replaced with "URI": when the namespace table has no prefix entry for the URI
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 187, is serialized as XML schema type *`xsd:byte`* and has underlying base type `char`
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 190, is serialized as XML schema type *`xsd:unsignedByte`* and has underlying base type `unsigned char`
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 193, is serialized as XML schema type *`xsd:ID`* and has underlying base type `std::string`, which should be
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 203, is serialized as XML schema type *`xsd:IDREF`* and has underlying base type `std::string`, which should be
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 220, is serialized as XML schema type *`xsd:anyURI`* and has underlying base type `std::string`
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 258, is serialized as XML schema type *`xsd:decimal`* and has underlying base type `std::string`, which should be
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 275, is serialized as XML schema type *`xsd:duration`* and has underlying base type `std::string`, which should be
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 427, is serialized as XML schema type *`ns2:char`* and has underlying base type `int`
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 441, is serialized as XML schema type *`ns2:duration`* and has underlying base type `std::string`, which should be
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 454, is serialized as XML schema type *`ns2:guid`* and has underlying base type `std::string`, which should be
...
This typedef is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 490, is serialized as XML schema type *`ns5:StreamBody`* and has underlying base type `xsd__base64Binary`
...
<tr><td><code> ns2__guid </code></td><td><code> ns2__guid </code></td><td> std::string </td><td> ns2:guid </td></tr>
...
<tr><td><code> ns2__duration </code></td><td><code> ns2__duration </code></td><td> std::string </td><td> ns2:duration </td></tr>
...
<tr><td><code> std::vector<ns3__SignaturItem *>  </code></td><td><code> std__vectorTemplateOfPointerTons3__SignaturItem </code></td><td> container </td><td> ns3:SignaturItem </td></tr>
<tr><td><code> std::vector<ns3__PayItem *>  </code></td><td><code> std__vectorTemplateOfPointerTons3__PayItem </code></td><td> container </td><td> ns3:PayItem </td></tr>
<tr><td><code> std::vector<ns3__ChargeItem *>  </code></td><td><code> std__vectorTemplateOfPointerTons3__ChargeItem </code></td><td> container </td><td> ns3:ChargeItem </td></tr>
</table>
...
This service operation is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 1275 and has the following properties:
...
This service operation is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 1345 and has the following properties:
...
This service operation is declared in [.\lib\gsoap\gsoap\bin\win32\ftservice.h](.\lib\gsoap\gsoap\bin\win32\ftservice.h) at line 1415 and has the following properties:
...
_Generated on Wed Feb 26 2020 10:56:41 UTC by soapcpp2 v2.8.97 for .\lib\gsoap\gsoap\bin\win32\ftservice.h._
