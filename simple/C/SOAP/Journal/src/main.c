...
void init_struct(struct _ns1__EchoResponse *Echo_response,
                 struct _ns1__Echo *Echo_request, char *message) {
...
int main() {
  printf("This example sends a sign request to the fiskaltrust.Service via "
         "SOAP\n");
  ...
  */
  ...
  char ServiceURL[] = {
      "http://localhost:1200/c5b315c4-0e49-46d9-8558-df475fe5c680"};
