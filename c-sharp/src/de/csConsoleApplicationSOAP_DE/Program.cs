...
namespace csConsoleApplicationSOAP_DE
{
    class Program
    {
        static int i = 0;
        ...
        static void Menu()
        {
            ...
            Console.WriteLine("3: End Transaction (0x444500000000000B)");
            ...
            Console.WriteLine("7: POS Receipt with Implicit Transaction (0x4445000100000001)");
        ...
        static void Command(string input)
        {
            ...
            {
                var stream = proxy.Journal(0x4445000000000000, 0, DateTime.UtcNow.Ticks);
            ...
            {
                var req = UseCaseRequest(lastTransactionId, 0x444500000000000B, (decimal)((new Random()).NextDouble() * 10.0), (decimal)((new Random()).NextDouble() * 10.0), cashBoxId);
            ...
            else if (inputInt == 9)
            {
                ...
                {
                    using (var journal = proxy.Journal(0x4445000000000000, 0, 0 /*(new DateTime(2999,12,31)).Ticks*/))
                    {
                        journal.CopyTo(file);
                    }
        ...
        internal static ReceiptRequest UseCaseRequest(string receiptReference, long receiptCase, decimal amount1 = 4.8m, decimal amount2 = 3.3m, string cashBoxId = "")
        {
